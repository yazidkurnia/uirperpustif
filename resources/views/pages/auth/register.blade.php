...
<body monica-id="ofpnmcalabcbjgholdjcjblkibolbppb" monica-version="7.1.0">
                    ...
                    <div class="card-body">
                        ...
                        <form id="formAuthentication" method="POST" class="mb-6"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-6">
                                        <label for="text" class="form-label">Npm or Nidn</label>
                                        <input type="text" class="form-control" id="usercode" name="usercode"
                                            placeholder="Enter your NPM or NDIN">
                                    </div>
                                </div>
                            </div>
    ...
    <script src="{{ asset('assets/ndor/libs/popper/popper.js') }}"></script>
    <script src="{{ asset('assets/vendor/js/bootstrap.js') }}"></script>
    <script src="{{ asset('assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.js') }}"></script>
    <script src="{{ asset('assets/vendor/js/menu.jsve') }}"></script>
    ...
    <div id="om-j9ddizqmza7l40oaxpsb-holder"></div>
    <div id="om-ep1ks6srx4n8vrqhhxd4-holder"></div>
    <div id="om-hglrf0do0pyjgx7pvawz-holder"></div>
